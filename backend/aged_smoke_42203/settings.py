"""
Django settings for aged_smoke_42203 project.
...
ROOT_URLCONF = 'aged_smoke_42203.urls'
...
WSGI_APPLICATION = 'aged_smoke_42203.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_smoke_42203 API",
    "DESCRIPTION": "API documentation for aged_smoke_42203 App",
    "VERSION": "v1",
}
